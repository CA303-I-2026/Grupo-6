...
\subsection{Respuesta a la retroalimentación}
Durante la exposición de avance, se nos recomendó explorar con mayor profundidad los modelos estadísticos que podían utilizarse para responder la pregunta de investigación. En respuesta a esta observación, ampliamos la propuesta metodológica incorporando una comparación entre distintos métodos, incluyendo pruebas t, ANOVA, Kruskal-Wallis, correlaciones y modelos de regresión.

Asimismo, justificamos la selección del modelo final mediante métricas de ajuste, pruebas de significancia y diagnósticos del modelo. Esto permitió fundamentar mejor las decisiones metodológicas tomadas y fortalecer la interpretación de los resultados obtenidos.
...
\begin{itemize}
    ...
    Sintetiza las predicciones del modelo para distintos niveles de distracción académica.
...
title=Ficha 1. Prueba t: bajo/moderado uso vs alto uso]
...
\textbf{Conexión con la pregunta de investigación:} Este resultado ayuda a responder si el rendimiento académico cambia entre estudiantes con distinto nivel de uso de redes sociales. Aunque se observó una diferencia en la dirección esperada, la evidencia estadística fue insuficiente para concluir que exista una diferencia significativa entre ambos grupos.

\textbf{Contraste con la literatura:} Esta ficha puede compararse con estudios que sugieren una relación negativa entre el uso intensivo de redes sociales y el rendimiento académico. Nuestros resultados apuntan en esa dirección, pero la evidencia no fue lo suficientemente fuerte para confirmarla con este método.

\textbf{Lo que NO explica este resultado:} No explica si las redes sociales causan un menor promedio ni distingue entre usos académicos, recreativos o sociales.

\textbf{Implicación para el siguiente paso:} Fue necesario complementar este análisis con correlaciones y modelos de regresión que aprovecharan la información continua de las horas de uso.
\end{tcolorbox}

\begin{tcolorbox}[
colback=blue!5,
colframe=blue!75!black,
title=Ficha 2. ANOVA: comparación entre cuatro categorías]

\textbf{Nivel descriptivo: qué encontramos}

\textbf{Titular:} No se detectaron diferencias claras entre categorías.

\textbf{Nombre del hallazgo/resultado:} Comparación del promedio académico entre cuatro categorías de uso de redes sociales.

\textbf{Resumen en una oración:} Las diferencias observadas entre categorías no fueron estadísticamente significativas.
...
\textbf{Conexión con la pregunta de investigación:} El ANOVA permitió evaluar si el rendimiento académico cambia según distintos niveles de uso diario de redes sociales. Aunque se observaron algunas diferencias descriptivas entre grupos, estas no fueron suficientemente grandes para concluir que existan diferencias significativas en la población.

\textbf{Contraste con la literatura:} Este resultado es consistente con investigaciones que encuentran relaciones débiles o poco concluyentes entre el tiempo de uso de redes sociales y el rendimiento académico. Sugiere que otros factores pueden ser más importantes para explicar las diferencias observadas.

\textbf{Lo que NO explica este resultado:} No identifica qué factores adicionales influyen en el rendimiento académico ni permite establecer relaciones causales.
...
colback=blue!5,
colframe=blue!75!black,
title=Ficha 3. Kruskal-Wallis: respaldo no paramétrico]

\textbf{Nivel descriptivo: qué encontramos}

\textbf{Titular:} La evidencia sigue siendo insuficiente.

\textbf{Nombre del hallazgo/resultado:} Comparación no paramétrica entre categorías de uso de redes sociales.

\textbf{Resumen en una oración:} La prueba no paramétrica tampoco encontró diferencias significativas entre categorías.
...
\textbf{Conexión con la pregunta de investigación:} Esta prueba permitió verificar si las conclusiones del ANOVA se mantenían al utilizar un método que no requiere supuestos estrictos de normalidad. El resultado fue consistente: no se encontró evidencia suficiente de diferencias significativas entre los grupos de uso de redes sociales.
...
\textbf{Implicación para el siguiente paso:} Los resultados reforzaron la necesidad de utilizar correlaciones y modelos de regresión para aprovechar la información continua de las horas de uso.
\end{tcolorbox}
...
colback=blue!5,
colframe=blue!75!black,
title=Ficha 4. Pearson: horas en redes vs promedio]
...
\textbf{Contraste con la literatura:} Este resultado coincide parcialmente con Aljemely (2020), quien encontró que el uso problemático de teléfonos inteligentes y redes sociales puede relacionarse con un menor rendimiento académico. También es consistente con Ogunbiyi (2024), que reporta una influencia negativa del uso excesivo de redes sociales sobre el desempeño académico de estudiantes universitarios. Sin embargo, la asociación observada en nuestro estudio es moderada, por lo que también guarda relación con León Luyo et al. (2023), quienes no encontraron una relación significativa entre ambas variables.
...
colback=blue!5,
colframe=blue!75!black,
title=Ficha 5. Spearman: horas en redes vs promedio]
...
\textbf{Contraste con la literatura:} La correlación de Spearman respalda la idea de que la relación entre redes sociales y rendimiento académico no siempre es simple ni completamente lineal. Este resultado coincide con León Luyo et al. (2023), quienes no encontraron una asociación clara entre ambas variables, y con Rodelo Moreno y Lizárraga Reyes (2018), quienes señalan que el impacto de las redes depende en gran medida de la forma en que son utilizadas por los estudiantes.
...
colback=blue!5,
colframe=blue!75!black,
title=Ficha 6. Pearson: horas de estudio vs promedio]

\textbf{Nivel descriptivo: qué encontramos}

\textbf{Titular:} Más horas de estudio se asocian con mejores promedios.
...
\textbf{Contraste con la literatura:} Este resultado coincide con Sotelo Correa et al. (2023) y Ramírez Jaime et al. (2023), quienes señalan que el rendimiento académico está influenciado por múltiples factores además del uso de redes sociales. Nuestros resultados muestran que las horas de estudio presentan una asociación positiva con el promedio académico, reforzando la idea de que los hábitos de estudio son una variable relevante para comprender el desempeño estudiantil.
...
colback=blue!5,
colframe=blue!75!black,
title=Ficha 7. Distracción académica vs promedio]

\textbf{Nivel descriptivo: qué encontramos}

\textbf{Titular:} La distracción se asocia con menores promedios.
...
\textbf{Contraste con la literatura:} Este resultado coincide con Ogunbiyi (2024), quien plantea que los efectos negativos de las redes sociales sobre el rendimiento académico pueden estar relacionados con problemas de concentración y atención. También guarda relación con Aljemely (2020), quien encontró que la adicción a redes sociales y teléfonos inteligentes puede afectar el desempeño académico a través de mecanismos asociados con la distracción y la pérdida de concentración.
...
colback=blue!5,
colframe=blue!75!black,
title=Ficha 8. Diagnóstico del modelo]
...
colback=blue!5,
colframe=blue!75!black,
title=Ficha 9. Modelo seleccionado]
...
\textbf{Conexión con la pregunta de investigación:} El modelo permite responder que existe evidencia de una asociación negativa entre las horas de uso de redes sociales y el rendimiento académico, incluso después de considerar variables como horas de estudio, asistencia y distracción académica. Además, las horas de estudio y la asistencia presentan asociaciones positivas con el promedio académico, mientras que la distracción académica muestra una asociación negativa. Aunque se exploró una posible interacción entre el uso de redes sociales y la distracción académica, esta no resultó estadísticamente significativa, por lo que no se encontró evidencia suficiente para afirmar que el efecto de las redes cambie según el nivel de distracción.

\textbf{Contraste con la literatura:} El modelo seleccionado muestra que las horas en redes sociales y la distracción académica se asocian negativamente con el rendimiento académico, mientras que las horas de estudio y la asistencia presentan asociaciones positivas. Estos resultados coinciden parcialmente con \cite{aljemely2020}, Ogunbiyi (2024) y Ramírez Jaime et al. (2023), quienes reportan efectos negativos del uso excesivo de redes sociales sobre el desempeño académico. Sin embargo, nuestros hallazgos también son consistentes con León Luyo et al. (2023) y Rodelo Moreno y Lizárraga Reyes (2018), quienes sugieren que la relación entre redes sociales y rendimiento académico no es uniforme y depende de otros factores. En conjunto, nuestros resultados respaldan la idea de que el rendimiento académico es un fenómeno multifactorial que no puede explicarse únicamente por el tiempo de uso de redes sociales.
...
Al comparar nuestros resultados con los estudios revisados al inicio del proyecto, observamos que existen puntos en común, pero también algunas diferencias. En nuestro análisis encontramos que las horas de uso de redes sociales y la distracción académica presentan una relación negativa con el promedio académico. Por el contrario, las horas de estudio y la asistencia muestran una relación positiva con el rendimiento.

Estos resultados coinciden con lo planteado por Aljemely (2020), quien señala que el uso excesivo de redes sociales y teléfonos inteligentes puede afectar el desempeño académico. De manera similar, Ogunbiyi (2024) menciona que las redes sociales pueden convertirse en un factor que dificulte la concentración de los estudiantes, mientras que Ramírez Jaime et al. (2023) destacan la relación entre el uso problemático de redes sociales y distintas dificultades académicas.

Sin embargo, no todos los trabajos revisados llegan a las mismas conclusiones. León Luyo et al. (2023), por ejemplo, no encontraron evidencia suficiente para afirmar que existe una relación significativa entre el uso de redes sociales y el rendimiento académico. Asimismo, Rodelo Moreno y Lizárraga Reyes (2018) sugieren que los efectos pueden variar dependiendo del uso que cada estudiante haga de estas plataformas.

Los resultados obtenidos en nuestro proyecto parecen ubicarse en una posición intermedia. Aunque encontramos evidencia de una asociación entre el uso de redes sociales y el promedio académico, esta relación no es lo suficientemente fuerte como para explicar por sí sola el rendimiento de los estudiantes. De hecho, variables como las horas de estudio, la asistencia y la distracción académica también mostraron una influencia importante dentro del modelo.

Por esta razón, consideramos que el rendimiento académico debe entenderse como un fenómeno en el que intervienen múltiples factores. Las redes sociales forman parte de esa explicación, pero no son el único elemento que influye en los resultados académicos observados en nuestra muestra.
...
Con base en los elementos anteriores se propone el siguiente orden para la redacción del artículo final.
...
Resultados & Influencia de horas de estudio(Secundario) \\
\midrule
...
colback=gray!5,
colframe=black!75,
title={Log de contribuciones},
fonttitle=\bfseries
]

\textbf{Katia Moreno:} Colaboró en la redacción y organización general de la Bitácora 3. Participó en la elaboración de la introducción, el rastro de decisiones, la definición de la audiencia, los elementos de comunicación, el orden propuesto para el artículo y el desarrollo del arco narrativo. Asimismo, contribuyó en la sección de escritura y en la elaboración del diario de aprendizaje.

\vspace{0.3cm}

\textbf{Luis Elizondo :} Participó en el análisis de modelación y en la construcción de la propuesta metodológica. Además, colaboró en la redacción de las secciones relacionadas con la selección, justificación e interpretación de los métodos estadísticos utilizados en el proyecto.

\vspace{0.3cm}

\textbf{Sebastián Calderón:} Se encargó de la programación y ejecución de los análisis estadísticos realizados durante esta etapa del proyecto. Asimismo, elaboró las fichas de resultados iniciales y participó en la construcción e interpretación del modelo estadístico seleccionado.

\vspace{0.3cm}

\textbf{Jeremy García:} Complementó las fichas de resultados mediante la incorporación del contraste con la literatura revisada, fortaleciendo la interpretación de los hallazgos. Además, diseñó el aspecto visual de las fichas en \LaTeX{}, elaboró el log de contribuciones y el registro de uso de inteligencia artificial, y realizó la revisión final del documento para verificar la coherencia y consistencia de la bitácora.
...
Explícame cómo interpretar los resultados de una correlación de Pearson, una correlación de Spearman y un modelo de regresión lineal múltiple dentro de un proyecto de investigación.

\textbf{Respuesta de la IA:}
La IA explicó el significado de los coeficientes de correlación, la diferencia entre asociación y causalidad, y cómo interpretar los coeficientes de un modelo de regresión considerando las demás variables incluidas.

\textbf{Evaluación:}
La respuesta fue útil para comprender mejor los resultados obtenidos y para redactar las conclusiones de manera adecuada. Sin embargo, fue necesario contrastar las explicaciones con los contenidos vistos en clase para asegurar que fueran consistentes con el enfoque del curso.

\textbf{Modificaciones:}
Se utilizaron las explicaciones como guía para interpretar los resultados, pero las conclusiones finales se redactaron utilizando únicamente la evidencia obtenida en los análisis realizados.

\textbf{Aprendizaje:}
Aprendimos que una asociación estadística no implica causalidad y que los resultados deben interpretarse considerando las limitaciones de los datos y del modelo utilizado.
...
colback=blue!5,
colframe=blue!75!white,
title=Apoyo en redacción académica]
\textbf{Herramienta:} ChatGPT

\textbf{Prompt:}

Ayúdame a mejorar la redacción de la sección de discusión preliminar de mi proyecto sobre redes sociales y rendimiento académico. Quiero que tenga un tono académico, pero que sea fácil de entender y coherente con los resultados obtenidos.

\textbf{Respuesta de la IA:}
La IA sugirió reorganizar las ideas principales de la discusión, conectar los resultados con la literatura revisada y enfatizar que los hallazgos corresponden a asociaciones estadísticas y no a relaciones causales.

\textbf{Evaluación:}
La respuesta fue útil porque permitió mejorar la claridad y fluidez del texto. Sin embargo, algunas frases propuestas eran demasiado generales y debieron adaptarse a los resultados específicos del proyecto.

\textbf{Modificaciones:}
Se ajustó la redacción para incorporar los resultados reales obtenidos en el modelo y se eliminaron afirmaciones que no estaban respaldadas por los datos analizados.

\textbf{Aprendizaje:}
Aprendimos la importancia de diferenciar entre describir resultados y discutir su significado dentro del contexto de la investigación.
...
colback=blue!5,
colframe=blue!75!white,
title=Diseño visual de las fichas en LaTeX]
\textbf{Herramienta:} ChatGPT

\textbf{Prompt:}

¿Cómo puedo crear fichas de resultados en LaTeX utilizando cuadros de color para que se vean más organizadas y profesionales dentro de la Bitácora 3?

\textbf{Respuesta de la IA:}
La IA sugirió utilizar el paquete tcolorbox para encerrar cada ficha en cuadros de color. También proporcionó ejemplos de código para personalizar el color de fondo, color de borde, tamaño del título y espaciado interno, con el fin de mejorar la presentación visual del documento.

\textbf{Evaluación:}
La respuesta fue útil porque permitió mejorar significativamente la organización y apariencia de las fichas de resultados. Sin embargo, algunos ejemplos debieron ajustarse para mantener consistencia con el formato general de la bitácora y evitar problemas de compatibilidad con otros elementos del documento.

\textbf{Modificaciones:}
Se modificaron los colores, márgenes y estilos propuestos para adaptarlos al diseño final de la bitácora. Además, se ajustó el código para integrarlo correctamente con las secciones y subsecciones ya existentes en el documento.

\textbf{Aprendizaje:}
Aprendimos a utilizar el paquete \textit{tcolorbox} para mejorar la presentación visual de documentos en LaTeX y comprendimos cómo pequeños cambios en el diseño pueden facilitar la lectura y organización de los resultados.
