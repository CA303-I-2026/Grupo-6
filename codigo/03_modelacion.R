...
# ------------------------------------------------------------
# 10. Interpretacion automatica breve para revisar resultados
# ------------------------------------------------------------
# Este bloque crea un archivo de texto con ideas que pueden usarse como guia
# para redactar la Bitacora 3. No reemplaza la interpretacion del grupo.

coef_m3 <- tidy(modelo_3, conf.int = TRUE)

sink(file.path(ruta_salidas, "22_guia_interpretacion_modelo_3.txt"))

cat("GUIA DE INTERPRETACION - MODELO 3\n")
cat("=================================\n\n")

cat("Pregunta de investigacion:\n")
cat("Existe relacion entre el uso de redes sociales y el rendimiento academico?\n\n")

cat("Modelo seleccionado:\n")
cat("promedio ~ horas_redes * distraccion_acad + horas_estudio + asistencia\n\n")

cat("Por que este modelo?\n")
cat("- Incluye horas en redes, que es la variable principal del proyecto.\n")
cat("- Incluye distraccion academica, porque la Bitacora 2 sugirio que podria explicar mejor las diferencias de rendimiento.\n")
cat("- Incluye horas de estudio y asistencia, porque son variables academicas importantes.\n")
cat("- Incluye la interaccion horas_redes:distraccion_acad para evaluar si el efecto de las redes cambia segun el nivel de distraccion.\n\n")
...
cat("\nDiagnosticos:\n")
cat("- Revisar diagnostico_01_residuales_vs_ajustados.png para ver si hay patrones fuertes.\n")
cat("- Revisar diagnostico_02_qqplot_residuales.png para normalidad aproximada.\n")
cat("- Revisar diagnostico_04_distancia_cook.png para valores influyentes.\n")
cat("- Revisar 20_vif_modelo_3.csv para multicolinealidad.\n\n")

cat("Cuidado al interpretar:\n")
cat("Estos modelos muestran asociacion, no causalidad. No podemos decir que las redes causan bajo rendimiento.\n")
cat("Solo podemos decir si, dentro de esta muestra, las variables se relacionan estadisticamente.\n")
...
cat("Datos usados:", ruta_datos, "\n")
cat("Figuras guardadas en:", ruta_figuras, "\n")
cat("Tablas y salidas guardadas en:", ruta_salidas, "\n")
