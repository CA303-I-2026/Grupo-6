...
El uso de redes sociales forma parte del día a día de la mayoría de universitarios. Plataformas como TikTok, Instagram o WhatsApp ocupan un tiempo significativo a lo largo del día, incluso en momentos dedicados al estudio o a pausas durante el mismo.
\\
...
En las bitácoras anteriores realizamos una revisión bibliográfica sobre esta problemática y desarrollamos un análisis exploratorio de la base de datos utilizada en el proyecto. Estos análisis permitieron identificar algunos patrones de interés y plantear nuevas hipótesis sobre los factores que podrían estar asociados al rendimiento académico.
\\
En esta tercera bitácora avanzamos hacia una etapa más rigurosa del análisis. Para ello, proponemos distintas metodologías estadísticas que nos permitan evaluar si las diferencias observadas entre grupos de estudiantes son significativas, y determinar si existe evidencia estadística de una asociación entre el uso de redes sociales y el rendimiento académico.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{grafico_1_horas_redes_vs_promedio.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{grafico_5_heatmap_redes_distraccion_promedio.png}
